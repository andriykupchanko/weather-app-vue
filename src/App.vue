...
import { ApiKey, BaseUrl } from './constant/index.js';
            ...
            <section class="section section-left">
              <div class="info">
                <div class="city-inner">
                  <input v-model="city" @keyup="() => getWeather()" type="text" class="search">
                </div>
                <WeatherSummary />
              </div>
            </section>
...
@import url('./assets/styles/main.sass');
